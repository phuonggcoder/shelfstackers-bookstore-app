...
const ListItem = memo(({ item, isSelected, onSelect }: ListItemProps) => {
...
const AddressSelector: React.FC<AddressSelectorProps> = ({
  ...
  }, [selectedProvince?.code, selectedDistrict?.code, selectedWard?.code, handleProvinceSelect, handleDistrictSelect, handleWardSelect]);
              ...
              {loading ? (
                ...
                <View style={styles.listsContainer}>
                  <View style={styles.tabContainer}>
                    ...
                    >
                      <Text style={[styles.tabText, currentStep === 'province' && styles.activeTabText]}>
                        Tỉnh/Thành
                      </Text>
                    </TouchableOpacity>
                    <TouchableOpacity 
                    ...
                    >
                      <Text style={[styles.tabText, currentStep === 'district' && styles.activeTabText]}>
                        Quận/Huyện
                      </Text>
                    </TouchableOpacity>
                    <TouchableOpacity 
                    ...
                    >
                      <Text style={[styles.tabText, currentStep === 'ward' && styles.activeTabText]}>
                        Phường/Xã
                      </Text>
                    </TouchableOpacity>
                  </View>
            ...
            <View style={styles.modalFooter}>
              ...
              <TouchableOpacity
                style={[
                  ...
                  (!selectedProvince || !selectedDistrict || !selectedWard) && styles.confirmButtonDisabled
                ]}
